 ...
 * generated in the ec.edu.ups.pw59.clienteAutoEv package. 
...
public class ObjectFactory {
    ...
    private final static QName _CrearContacto_QNAME = new QName("http://beans.evaWiliamChablaSRV.pw59.ups.edu.ec/", "crearContacto");
    private final static QName _CrearContactoResponse_QNAME = new QName("http://beans.evaWiliamChablaSRV.pw59.ups.edu.ec/", "crearContactoResponse");
    private final static QName _GetContactos_QNAME = new QName("http://beans.evaWiliamChablaSRV.pw59.ups.edu.ec/", "getContactos");
    private final static QName _GetContactosResponse_QNAME = new QName("http://beans.evaWiliamChablaSRV.pw59.ups.edu.ec/", "getContactosResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ec.edu.ups.pw59.clienteAutoEv
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://beans.evaWiliamChablaSRV.pw59.ups.edu.ec/", name = "crearContacto")
     ...
     */
    @XmlElementDecl(namespace = "http://beans.evaWiliamChablaSRV.pw59.ups.edu.ec/", name = "crearContactoResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://beans.evaWiliamChablaSRV.pw59.ups.edu.ec/", name = "getContactos")
     ...
     */
    @XmlElementDecl(namespace = "http://beans.evaWiliamChablaSRV.pw59.ups.edu.ec/", name = "getContactosResponse")
